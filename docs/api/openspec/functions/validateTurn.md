...
[@mcp-secure-context/openspec](../README.md) / validateTurn
...
\{ `ok`: `true`; `value`: [`AstroSpecTurn`](../interfaces/AstroSpecTurn.md); \} \| \{ `errors`: [`ValidationError`](../type-aliases/ValidationError.md)[]; `ok`: `false`; \}
