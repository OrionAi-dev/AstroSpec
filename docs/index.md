...
6. [Vendored release-artifact consumers](openspec/vendored-consumers.md)
7. [Current sprint](sprints/2026-04-17-cross-repo-secure-context-hardening.md)
8. [Legacy OpenSpec migration](migrations/legacy-openspec/README.md)
...
- [Vendored release-artifact consumers](openspec/vendored-consumers.md)
