...
const localSchemasDir = path.join(repoRoot, 'packages', 'openspec-agent-contracts', 'schemas');
...
console.log('[contracts] no drift detected between @openspec/agent-contracts schemas and starconsole-contracts');
